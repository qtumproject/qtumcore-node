...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `qtumcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ qtumcore-node add wallet-service');
      console.log('    $ qtumcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ qtumcore-node remove wallet-service');
      console.log('    $ qtumcore-node remove insight-api');
      console.log();
    });
