...
var BASE_PACKAGE = {
  ...
  dependencies: {
      /**
       * TODO:: will change after added to NPM
       */
    // 'bitcore-lib': '^' + bitcore.version,
    // 'bitcore-node': version
    'bitcore-lib': 'git+ssh://git@gitlab.pixelplex.by:593_qtum/bitcore-lib.git#master',
    'bitcore-node': 'git+ssh://git@gitlab.pixelplex.by:593_qtum/core-node.git#master'
  }
};
