...
/**
 * Will return the path and qtumcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'qtumcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'qtumcore-node.json'))
  };
}
