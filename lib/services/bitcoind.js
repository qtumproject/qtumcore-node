...
Bitcoin.prototype.getAPIMethods = function() {
  var methods = [
    ...
    ['callContract', this, this.callContract, 2],
  ...
  if (tx) {
    ...
    return self._tryAllClients(function(client, done) {
      ...
      return async.waterfall([function (callback) {
          ...
          return client.getTransactionReceipt(tx.hash, function (err, response) {

              if (err) {
                  return callback(err);
              }

              tx.receipt = response.result;
              return callback(null, tx);
          });
 ...
 * @param {Function} callback
 */
Bitcoin.prototype.getNewAddress = function(callback) {
    var self = this;
 ...
 * @param {Function} callback
 */
Bitcoin.prototype.callContract = function(address, hash, callback) {
    var self = this;

    this.client.callContract(address, hash, function(err, response) {
 ...
 * @param {Function} callback
 */
Bitcoin.prototype.getAccountInfo = function(address, callback) {
    var self = this;

    this.client.getAccountInfo(address, address, function(err, response) {
 ...
 * @param {Function} callback
 */
Bitcoin.prototype.getTransactionReceipt = function(trxHash, callback) {
    var self = this;

    this.client.getTransactionReceipt(trxHash, function(err, response) {
